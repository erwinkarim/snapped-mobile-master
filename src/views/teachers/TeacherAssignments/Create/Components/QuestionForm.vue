<template>
  <dashboard-layout>
    ...
    <template v-slot:content>
      <div class="flex-wrap relative top-12">
        <!-- DESCRIPTION -->
        ...
        <div class="relative w-full px-7 mt-3 max-h-full">
          ...
          <div class="flex mb-4 -mx-1">
            <div class="w-1/2 h-12 px-1">
              <router-link :to="{name:'teacher.assignments.manual-description'}" tag="button"
                           class="pl-6 pr-2 py-5 mt-2 appearance-none border rounded-md border-none w-full bg-gray-secondary text-purple-secondary text-lg font-normal leading-tight focus:outline-none focus:shadow-outline">
                <icon-base-two class="w-12">
                  <pen-icon class="w-12"></pen-icon>
                </icon-base-two>
                Manual
              </router-link>
            </div>
            <div class="w-1/2 h-12 px-1">
              <button
                  class="pl-6 pr-2 py-5 mt-2 text-center appearance-none border rounded-md border-none w-full bg-gray-secondary text-purple-secondary text-lg font-normal leading-tight focus:outline-none focus:shadow-outline">
                <icon-base-two class="w-12">
        ...
        <!-- DESCRIPTION -->
        <div class="w-full break-words px-7 mt-20 text-left text-purple-secondary text-sm leading-snug">
...
export default {
  ...
  components: {
    PageHeaderThree,
    DashboardLayout,
    NavBack, PageTitle, PageTitleTwo, PageTitleThree, PenIcon, CameraIcon, IconBaseTwo
  }
}
</script>
