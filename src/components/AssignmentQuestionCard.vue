<template>
	<div :class="isPreviewing ? '' : 'px-2 md:px-8'" class="mt-4">
		<div :class="isPreviewing ? 'bg-white' : 'bg-gray-secondary rounded-2xl text-left py-8 px-2 md:px-6'">

			<div v-if="!isPreviewing">
				<!-- TITLE -->
				<text-multiline-truncate :lines="2" class="text-2xl font-semibold text-purple-primary" >
					{{ assignment.title }}
